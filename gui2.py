...
def update_text():
    try:
        ...
        response1 = client.read_holding_registers(address=3019, count=2, unit=1)
        response2 = client.read_holding_registers(address=3009, count=2, unit=1)
        response3 = client.read_holding_registers(address=3059, count=2, unit=1)
        response4 = client.read_holding_registers(address=3109, count=2, unit=1)
